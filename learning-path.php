...
class PBD_Learning_Path {
    ...
    public function pbd_learning_path_func( $atts ) {
        ...
        $atts = shortcode_atts( array(
            'course_id' => '',
            'locked_bottom_color' => '#A4B1EC',
            'locked_top_color' => '#E1E5F9',
            'next_bottom_color' => '#5058A9',
            'next_top_color' => '#677DDF',
            'finish_top_color' => '#E1E5F9',
            'finish_bottom_color' => '#A4B1EC',
            'trophy_color' => '#A4B1EC',
            'completed_trophy_color' => '#F7D219',
            'dark_trophy_color' => '#F3A000',
            'path_top_color' => '#E1E5F9',
